        ...
        <div className="item pointer task" style={{backgroundColor: props.goal.color, overflow:"auto"}} onClick={(event) =>props.onToggle(props.goal.id,props.task.id)}>
            <div className="header" >
                ...
                <div style={{display:"grid", gridTemplateColumns:"1fr 1fr", alignItems:'center'}}>
                    <ReOrderButtons styling="goal-reorder" style={{fontSize:'100px'}} reOrderUp={() => props.reOrderTaskUp(props.goal.id,props.task.id, props.goal.tasks, true)} reOrderDown={() => props.reOrderTaskDown(props.goal.id,props.task.id, props.goal.tasks, true)} />
